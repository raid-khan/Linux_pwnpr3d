...
public class A8_CSRF {

    @Test
    public void CWE152unauthorizedTest() {
        ...
        webApp1.addVulnerabilityProbability(CWEType.CWE_152,PrivilegeType.Guest, AccessVectorType.Adjacent_Network,100);
        ...
        // All the accounts are compromised, people's actions are controlled through CSRF
